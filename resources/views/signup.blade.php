@include('header')
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="text" placeholder="123 Street" name="pass">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Mobile No</label>
                            <input class="form-control" type="text" placeholder="+123 456 789" name="PhoneNo">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address</label>
            ...
            <div class="col-lg-4">
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Other Options</span></h5>
                <div class="bg-light p-30 mb-5">
                <h6 class="mb-3"><button class="btn btn-light w-100" > Google</button></h6>
                        <h6 class="mb-3"><button class="btn btn-light w-100" > Facebook</button></h6>
                        <h6 class="mb-3"><button class="btn btn-light w-100" > Ios</button></h6>
                   
                </div>
                <div class="mb-5">
                    <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Already A User ?</span></h5>
                    <div class="bg-light p-30">
                        
                        
                        <button class="btn btn-block btn-primary font-weight-bold py-3">Go to Log IN Page</button>
                    </div>
                </div>
            </div>
        </div>
